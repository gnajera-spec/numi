...
export function LoginPage() {
  const { login, loginMfaChallenge } = useAuth();
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', overflow: 'auto', background: 'var(--color-bg-app)' }}>
      ...
      <div id="login-brand" style={{
        ...
        {/* Fondo decorativo: isotipo gigante semitransparente */}
        <div style={{
        ...
        <div style={{ position: 'relative' }}>
          ...
          <p style={{
            ...
            Accedé a tus recibos, solicitá licencias y leé comunicados institucionales desde un solo lugar.
          </p>
        </div>

        {/* Feature pills */}
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, position: 'relative' }}>
          {['Recibos digitales', 'Licencias', 'Comunicados', 'Perfil'].map(f => (
            <span key={f} style={{
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          {!mfaToken ? (
            <>
              {/* Logo (solo mobile) */}
              <div id="login-mobile-logo" style={{ marginBottom: 32, display: 'none', justifyContent: 'center' }}>
              ...
              <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                <Field id="email" label="Correo electrónico" type="email"
                  autoComplete="email" required value={email} onChange={setEmail} />
              ...
              <div style={{ marginTop: 24, display: 'flex', flexDirection: 'column', gap: 10, alignItems: 'center' }}>
                ...
                <p style={{ fontSize: 13, color: 'var(--color-text-secondary)', margin: 0,
                  fontFamily: "'Montserrat', system-ui, sans-serif" }}>
                  ¿Primera vez?{' '}
                  <Link to="/employee/activate" style={{ color: 'var(--color-primary)', fontWeight: 600, textDecoration: 'none' }}>
                    Activá tu cuenta
                  </Link>
                </p>
              </div>
            ...
            <>
              ...
              <h2 style={{ fontSize: 22, fontWeight: 800, margin: '0 0 6px', color: 'var(--color-text-primary)',
                fontFamily: "'Montserrat', system-ui, sans-serif" }}>
              ...
              <button onClick={() => { setMfaToken(null); setError(null); setTotpCode(''); }}
                style={{
