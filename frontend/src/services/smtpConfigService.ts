...
export const smtpConfigService = {
  ...
  upsert: (data: SmtpConfigIn) =>
    apiClient.put<SmtpConfigOut>("/admin/configuracion/smtp", data),

  test: (data: SmtpConfigIn) =>
    apiClient.post<SmtpTestResult>("/admin/configuracion/smtp/test", data),
};
